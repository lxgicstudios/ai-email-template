...
![npm](https://img.shields.io/npm/v/ai-email-template)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-email-template)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Email template generation and management system

Email template generator. Creates responsive HTML emails with pre-built components.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-email-template.svg)](https://badge.fury.io/js/ai-email-template)
